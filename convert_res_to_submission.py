...
if __name__ == "__main__":
    ...
    for file_path in tqdm(glob('/home/yujia/Desktop/kaggle/yolov5/runs/detect/orig_conf01_iou4_60_f1_3_rerun/labels/*txt')):
    ...
    sub_df.to_csv('/home/yujia/Desktop/kaggle/Detection/tt3.csv', index=False)
    sub_df.tail()
